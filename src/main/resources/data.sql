INSERT INTO user_entity (username, password, name, nick_Name, role) VALUES ('user1', 'p1', 'UserOne', 'NickName1', 'USER');
INSERT INTO user_entity (username, password, name, nick_Name, role) VALUES ('user2', 'p2', 'UserTwo', 'NickName2', 'USER');
